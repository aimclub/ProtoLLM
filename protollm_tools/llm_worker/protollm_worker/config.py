...
class Config:
    ...
    Attributes:
        ...
        redis_prefix: Prefix for keys used in Redis. Defaults to "llm_api".
        ...
        queue_name: The name of the RabbitMQ queue to use. Defaults to "llm_api-queue".
