...
def llm_request():
    ...
    prompt_msg = (
        "What has a head like cat, feet like a kat, tail like a cat, but isn't a cat?"
    )
    meta = {"temperature": 0.5, "tokens_limit": 10, "stop_words": ["Stop"]}
    llm_request = {"job_id": str(random_id), "meta": meta, "content": prompt_msg}
    return llm_request
